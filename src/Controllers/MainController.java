...
public class MainController {
    ...
    @FXML
    void toPAdmin(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/Paneles/PanelAdministrador.fxml"));
        scene = new Scene(root);
        Pane panel = (Pane) scene.lookup("#mainPanel");
    ...
    @FXML
    void toPGerente(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/Paneles/PanelGerente.fxml"));
        scene = new Scene(root);
        Pane panel = (Pane) scene.lookup("#mainPanel");
    ...
    @FXML
    void toPVendedor(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/Paneles/Cartelera.fxml"));
        scene = new Scene(root);
        Pane panel = (Pane) scene.lookup("#mainPanel");
    ...
    @FXML
    private void setUpScene(ActionEvent event, Pane pane, Scene scene) {
